...
- When the user chooses the cloud copy, v1.3.3 restores the cloud backup exactly. Local Daily Summary and DPP detail are no longer preserved during this full-copy restore; the chosen copy wins.
